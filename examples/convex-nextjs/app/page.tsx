    ...
    <>
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md p-4 border-b border-slate-200 dark:border-slate-700 flex flex-row justify-between items-center shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-semibold text-slate-800 dark:text-slate-200">Convex + Next.js</h1>
        </div>
        <AuthPopoverButton />
      </header>
...
function Content() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-lg mx-auto">
      <div>
        <h2 className="font-bold text-xl text-slate-800 dark:text-slate-200">Welcome!</h2>
        <p className="text-slate-600 dark:text-slate-400 mt-2">
          This demo app generates random numbers and stores them in your Convex database.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm">
          Click the button below to generate a new number. The data is persisted in the Convex cloud
          database - open this page in another window and see the data sync automatically!
        </p>
        <button
        ...
        <div className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-xl p-4 shadow-sm">
          <p className="font-semibold text-slate-800 dark:text-slate-200 mb-2">Newest Numbers</p>
      ...
      <div className="flex flex-col gap-3">
        <h2 className="font-semibold text-xl text-slate-800 dark:text-slate-200">Making changes</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm">
          Edit{" "}
      ...
      <div className="flex flex-col gap-4">
        <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200">Useful resources</h2>
...
function AuthPopoverButton() {
  ...
  const [selectedAuth, setSelectedAuth] = useState<"authkit" | "clerk" | "convexauth">("authkit");
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[560px] bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-xl shadow-xl z-50 p-6">
          <p className="text-slate-700 dark:text-slate-300 text-sm mb-4">
            You can create a copy of this project with auth integrated by using this command.
          </p>
          ...
          <div className="flex flex-col gap-3 mb-4">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-slate-700 dark:text-slate-300 text-sm">WorkOS AuthKit</span>
            </label>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-slate-700 dark:text-slate-300 text-sm">Clerk</span>
            </label>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                ...
                onChange={(e) => setSelectedAuth(e.target.value as "convexauth")}
                className="w-4 h-4 cursor-pointer"
              />
              <Image src="/convex.svg" alt="Convex" width={20} height={20} />
              <span className="text-slate-700 dark:text-slate-300 text-sm">Convex Auth</span>
            </label>
          </div>
