...
const buildAgentHookScript = (): string =>
  [
    ...
    "",
    "run_react_doctor() {",
    "  if [ -x ./node_modules/.bin/react-convex-doctor ]; then",
    "    ./node_modules/.bin/react-convex-doctor --verbose --diff --blocking warning --no-score",
    "    return",
    "  fi",
    "",
    "  if command -v react-convex-doctor >/dev/null 2>&1; then",
    "    react-convex-doctor --verbose --diff --blocking warning --no-score",
    "    return",
    "  fi",
    "",
    "  if command -v pnpm >/dev/null 2>&1; then",
    "    pnpm dlx react-convex-doctor@latest --verbose --diff --blocking warning --no-score",
    "    return",
    "  fi",
    "",
    "  if command -v npx >/dev/null 2>&1; then",
    "    npx --yes react-convex-doctor@latest --verbose --diff --blocking warning --no-score",
    "    return",
    "  fi",
    "",
